...
Latest tag: **v0.2.5** (native Client window; fix Windows `\\` shortcut; Setup stops leftover processes)
...
1. Install GitHub Release **v0.2.5** `BMW-ENET-Setup.exe` (Windows CI builds on tag push).
...
- Finish ISTA end-to-end validation after Npcap + v0.2.5 install.
