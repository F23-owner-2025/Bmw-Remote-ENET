...
use enet_protocol::magic::{DEFAULT_API_PORT, DEFAULT_TUNNEL_PORT};
...
pub struct GatewayConfig {
    ...
    /// Peer address (required for agent; optional allowlist hint for gateway).
...
impl Default for GatewayConfig {
    fn default() -> Self {
        Self {
            ...
            bind_addr: None,
            peer_addr: None,
            allowed_cidrs: vec!["192.168.0.0/16".into(), "10.0.0.0/8".into(), "172.16.0.0/12".into()],
